...
export function PhotoGalleryWithTabs() {
    const data = [
        {
            label: "Wedding",
            value: "wedding",
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="my-8 container  w-full"> {/* Added margin top and bottom */}
                <Tabs value="wedding">
                    ...
                    <TabsBody className="grid grid-cols-1 gap-4 mt-4" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>  {/* Added margin top */}
                            ...
                            >
                                {images?.map(({ imageLink }, index) => (
                                    <div key={index} className="overflow-hidden rounded-lg">
                                        <img
                                            className="h-64 w-full object-cover object-center transition-transform duration-300 hover:scale-110"
                                            src={imageLink}
